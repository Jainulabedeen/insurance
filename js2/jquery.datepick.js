  ...
  alert('Selected ' + dates);
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				prevText: '<button class="btn btn-info">&nbsp;Prev&nbsp;</button>',
				prevStatus: 'Show the previous month',
				prevJumpText: '&lt;&lt;',
				prevJumpStatus: 'Show the previous year',
				nextText: '<button class="btn btn-info">&nbsp;Next&nbsp;</button>',
				nextStatus: 'Show the next month',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'Show the next year',
				currentText: 'Current',
				currentStatus: 'Show the current month',
				todayText: '<button class="btn btn-info">&nbsp;Today&nbsp;</button>',
				todayStatus: 'Show today\'s month',
				clearText: '<button class="btn btn-info">&nbsp;Clear&nbsp;</button>',
				clearStatus: 'Clear all the dates',
				closeText: '<button class="btn btn-info">&nbsp;Close&nbsp;</button>',
